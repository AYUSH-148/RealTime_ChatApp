...
const FriendRequestSidebarOption = ({ sessionId, initialUnseenRequestCount }: FriendRequestSidebarProps) => {
    const [unseenReqCount, setUnseenReqCount] = useState<number>(initialUnseenRequestCount)
